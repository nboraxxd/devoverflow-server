...
import { setVerifiedAuthorizationTokenToReq } from '@/utils/jwt'
  ...
  return async (req: Request, _res: Response, next: NextFunction) => {
    try {
      ...
      if (isLoginRequired) {
        ...
        await setVerifiedAuthorizationTokenToReq(parsedAccessToken, req)
        ...
        await setVerifiedAuthorizationTokenToReq(accessToken, req)
      }
